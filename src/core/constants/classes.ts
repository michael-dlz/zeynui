import { RadiusVariant, SizeVariant, VarianActiveClasses, VariantClasses } from "../types";



export const RADIUS_CLASSES: Record<RadiusVariant, string> = {
    none: "rounded-none",
    sm: "rounded-sm",
    md: "rounded-md",
    lg: "rounded-lg",
...
export const WRAPPER_INPUT_SELECT_CLASSES: VariantClasses = {
    solid: {
        primary:
...
export const INPUT_SELECT_CLASSES: VariantClasses = {
    solid: {
...
export const BUTTON_CLASSES: VariantClasses = {
    solid: {
    ...
    outline: {
        primary:
            "border border-primary/50 text-primary hover:bg-primary hover:text-white focus-visible:ring-primary",
        secondary:
            "border border-secondary/50 text-secondary hover:bg-secondary hover:text-white focus-visible:ring-secondary",
        danger:
            "border border-danger/50 text-danger hover:bg-danger hover:text-white focus-visible:ring-danger",
        warning:
            "border border-warning/50 text-warning hover:bg-warning hover:text-white focus-visible:ring-warning",
        success:
            "border border-success/50 text-success hover:bg-success hover:text-white focus-visible:ring-success",
    ...
    soft: {
        ...
        secondary:
            "bg-secondary/10 text-secondary hover:bg-secondary hover:text-white focus-visible:ring-secondary",
    ...
    underline: {
        ...
        secondary:
            "text-secondary border-b border-secondary hover:bg-secondary/10 focus-visible:ring-secondary",
...
export const SIZE_CLASSES: Record<SizeVariant, string> = {
...
export const SIZE_CLASSES_ONLY_ICON: Record<SizeVariant, string> = {
    sm: "size-[2rem] text-[0.6rem]",
    md: "size-[3rem] text-[0.8rem]",
    lg: "size-[4rem] text-[1rem]",
};

export const INPUT_SELECT_SIZE_CLASSES: Record<SizeVariant, string> = {
    sm: "text-[0.6rem] px-2 py-1.5",
    md: "text-[0.8rem] px-3 py-3",
    lg: "text-[1rem] px-4 py-4",
};

export const TAB_CLASSES: VarianActiveClasses = {
    solid: {
...
export const CHIP_CLASSES: VariantClasses = {
    solid: {
