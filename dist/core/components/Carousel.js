...
export const Carousel = ({ children, navigation = false, pagination = false, thumbnails = false, autoplay = false, interval = 3000, loop = false, align = "center", slidesToShow = 1, spacing = 10, duration = 25, dragFree = false, radiusThumbnails = "sm", className = "", }) => {
